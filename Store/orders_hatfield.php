...
//  QUERY WITH users_archi , r=order data u=customer data, cleaner and safer rather than putting values directly
$stmt = $conn->prepare("
...
//prevents sql injection and query safely
...
//This displays each order one by one in the table
<?php 
$sn = 1;
...
<?php endwhile; ?>
//safely outputs the stored value to avoid breaking the page
</table>
