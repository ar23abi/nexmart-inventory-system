...
if (isset($_POST['login'])) {
    ...
    $captcha_input = trim($_POST['captcha_input']);
        ...
        if ($username === "hatfield" && $password === "12345") {

            $_SESSION['userSession'] = true;
            setcookie("user_id", $username, time() + (86400 * 30), "/");

            header("Location:hatfield.php");
            exit();
        }
        
          
        if ($username === "london" && $password === "12345") {
            ...
            exit();
                ...
                if ($username === "watford" && $password === "12345") {

            $_SESSION['userSession'] = true;
            setcookie("user_id", $username, time() + (86400 * 30), "/");

            header("Location: watford.php");
            exit();
        }
