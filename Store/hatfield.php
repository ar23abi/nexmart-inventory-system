...
//  Fetch all products specifically for the Hatfield Store
$hatfield_products = $conn->query("SELECT * FROM store_hatfield ORDER BY created_at DESC");
...
<head>
    <meta charset="UTF-8" />
    <title>Hatfield Store Inventory</title>
    ...
    <section class="home-section">
        <nav>
            <div class="sidebar-button">
                ...
                <span class="dashboard">hatfield Inventory</span>
            </div>
            </nav>
        ...
        <div class="home-content">
            <div class="sales-boxes">
                <div class="recent-sales box" style="width: 100%;">
                    <div class="title">Hatfield Store In-Stock</div>
                    ...
                    <table class="inventory-table">
                        ...
                        <tbody>
                            <?php if ($hatfield_products->num_rows > 0): ?>
                                <?php while($product = $hatfield_products->fetch_assoc()): ?>
                                <tr>
                                    <td>
                            ...
                            <?php else: ?>
                                <tr>
                                    <td colspan="5" style="text-align:center; padding: 20px;">No stock currently in hatfield.</td>
                                </tr>
                            <?php endif; ?>
                        </tbody>
                    </table>
