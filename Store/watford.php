...
$hatfield_products = $conn->query("SELECT * FROM store_watford ORDER BY created_at DESC");
        ...
        <div class="home-content">
            <div class="sales-boxes">
                <div class="recent-sales box" style="width: 100%;">
                    <div class="title">Watford Store In-Stock</div>
                    ...
                    <table class="inventory-table">
                        ...
                        <tbody>
                            ...
                            <?php else: ?>
                                <tr>
                                    <td colspan="5" style="text-align:center; padding: 20px;">No stock currently in Watford.</td>
                                </tr>
                            <?php endif; ?>
                        </tbody>
                    </table>
